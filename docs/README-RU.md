...
<h1>Сборка</h1>
<p><i>Visual Studio 2019 (или позднее) and .NET 5 SDK необходимы</i></p>
<ul>
...
```
  <li>Восстановите пакеты и запустите сборку солюшена. При сборке будет вызван <b>binaries_extract.bat</b>, который автоматически скачает и поместит в выходную директорию файлы моделей и компоненты от Python.</li>
</ul>
